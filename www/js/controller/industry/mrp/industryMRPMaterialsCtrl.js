angular.module("arkabPortal").controller("industryMRPMaterialsCtrl", ['$scope', 'identityService', 'appConfig', 'industryService', '$timeout',
    function ($scope, identityService, appConfig, industryService, $timeout) {
        ...
        $scope.getMRP = function () {
            $scope.loading = true;
            industryService.getMaterialMRP().success(function (response) {
